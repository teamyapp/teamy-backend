...
const (
	Sprint_GetCurrentSprint_FullMethodName = "/Sprint/GetCurrentSprint"
...
func (c *sprintClient) GetCurrentSprint(ctx context.Context, in *GetCurrentSprintRequest, opts ...grpc.CallOption) (*SprintMsg, error) {
	out := new(SprintMsg)
	err := c.cc.Invoke(ctx, Sprint_GetCurrentSprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Sprint_GetCurrentSprint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Sprint_GetCurrentSprint_FullMethodName,
	}
