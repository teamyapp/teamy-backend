...
func InitGraphQLAPI(appName AppMame, serviceName ServiceName, environment env.Environment, logger telemetry.Logger, cloudWebAPIExternalBaseURL CloudWebAPIExternalBaseURL, mapServerURL MapServerURL, cloudAPIClientRegistry *client.Registry, realTimeStateSyncer *realtime.StateSyncer, jwtSigningKey JWTSigningKey, sqlDB *sql.DB) (gql.Service[gql2.Resolver], error) {
	...
	serviceApp := service.NewApp(logger, httpClient, cloudAPIClientRegistry, authorizer, toggles, factory, realTimeStateSyncer, app, appVersion, appVersionPrice, appVersionChange, appSecret, appPackageUploadSession, teamAppInstallation, team, tag, appTagRelation, appGroupRelation, jwtAuthority)
	...
	serviceGroup := service.NewGroup(logger, cloudAPIClientRegistry, factory, realTimeStateSyncer, repositoryGroup, groupMemberRelation, appGroupRelation, groupRolloutRelation, user, team, app)
	...
	serviceRollout := service.NewRollout(logger, cloudAPIClientRegistry, factory, realTimeStateSyncer, appGroupRelation, rollout, rolloutViewer, groupRolloutRelation, appRolloutRelation, groupMemberRelation, appVersion, repositoryVersionSelector, activator)
