...
type AppVersion interface {
	...
	FindAppVersionByAppIDAndVersionNumber(ct context.Context, appID uint64,
		versionNumber int32) (entity.AppVersion, *errs.Error)
	FindAppVersionByAppIDAndVersionNumberWithTx(ct context.Context, tx *transaction.Transaction, appID uint64,
		versionNumber int32) (entity.AppVersion, *errs.Error)
	FindAppVersionsByAppIDWithTx(ct context.Context, tx *transaction.Transaction,
