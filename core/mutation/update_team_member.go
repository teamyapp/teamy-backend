...
func (u *UpdateTeamMember) Execute(ct context.Context) *errs.Error {
...
func (u *UpdateTeamMember) GetClientNotifiers(ct context.Context) ([]*realtime.ClientNotifier, *errs.Error) {
