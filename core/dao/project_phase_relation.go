...
type ProjectPhaseRelation interface {
	...
	DeleteProjectPhaseRelationByProjectID(ct context.Context, tx *transaction.Transaction, projectID uint64) *errs.Error
	DeleteProjectPhaseRelationByPhaseID(ct context.Context, tx *transaction.Transaction, phaseID uint64) *errs.Error
}
