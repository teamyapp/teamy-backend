...
(
	...
	pull_request_node_id VARCHAR(20) NOT NULL 
	    REFERENCES apps_github_pull_request (github_pull_request_node_id) 
	    ON UPDATE CASCADE 
	    ON DELETE CASCADE,
...
-- +migrate Down
ALTER TABLE apps_github_pull_request
    ADD internal_task_id BIGINT;

DROP INDEX idx_apps_github_pull_request_internal_task_relation_internal_task_id
DROP TABLE apps_github_pull_request_internal_task_relation;
